...
function rebuildSnapshot(controls) {
  return {
    ...
    shootsPerPath: controls.shootsPerPath,
    shootLengthScale: controls.shootLengthScale,
    // Copied, like branchAngleRange: Leva hands back a mutable array.
    shootAngleRange: [...controls.shootAngleRange],
...
export function GroundTendrils({
  ...
  const treeBuildOptions = useMemo(() => ({
    ...
    shootsPerPath: rebuild.shootsPerPath,
    shootLengthScale: rebuild.shootLengthScale,
    shootAngleRange: rebuild.shootAngleRange,
