// Fits hand-drawn veins onto the UV petal mask. Overwrites tujlip-veins.png
// (prefer this over generate-veins when source art exists).
...
function buildFilledPetalMask(data, width, height) {
  return buildPetalMask(data, width, height, CONFIG.backgroundThreshold);
}
